...
#define v128_add4_64(v3, v2, v1, v0) vaddq_u64(vaddq_u64(v3, v2), vaddq_u64(v1, v0))

#define v128_add4_32(v3, v2, v1, v0) vaddq_u32(vaddq_u32(v3, v2), vaddq_u32(v1, v0))
...
#define v128_mulw32(v1, v0) vmull_u32(vmovn_u64(v1), vmovn_u64(v0))
...
#define v128_xor4(v3, v2, v1, v0) veorq_u32(veorq_u32(v3, v2), veorq_u32(v1, v0))
#endif
...
#define v128_aesencxor(v, k) v128_xor(vaesmcq_u8(vaeseq_u8(v, v128_zero)), k)
// default is x86_64 format.
#define v128_aesenc v128_aesencxor

// xor key with v before encryption, arm64 format.
#define v128_xoraesenc(v, k) vaesmcq_u8(vaeseq_u8(v, k))
...
#define v128_xoraesencxor(v, k_in, k_out) v128_xor(v128_xoraesenc(v, k_in), k_out)

#define v128_aesenc_nokey(v) vaesmcq_u8(vaeseq_u8(v, v128_zero))

#define v128_aesenclast(v, k) v128_xor(k, vaeseq_u8(v, v128_zero))

#define v128_aesenclast_nokey(v) vaeseq_u8(v, v128_zero)

#define v128_aesdec(v, k) v128_xor(k, vaesimcq_u8(vaesdq_u8(v, v128_zero)))

#define v128_aesdec_nokey(v) vaesimcq_u8(vaesdq_u8(v, v128_zero))

#define v128_aesdeclast(v, k) v128_xor(k, vaesdq_u8(v, v128_zero))

#define v128_aesdeclast_nokey(v) vaesdq_u8(v, v128_zero)
...
#define v64_set32(u32_1, u32_0) vcreate_u32(((uint64_t)(u32_1) << 32) | (uint64_t)(u32_0))

#define v64_set16(u16_3, u16_2, u16_1, u16_0)                                                                          \
    vcreate_u16(((uint64_t)(((uint32_t)(u16_3) << 16) | (uint32_t)(u16_2)) << 32) |                                    \
                ((uint64_t)(((uint32_t)(u16_1) << 16) | (uint32_t)(u16_0))))

#define v64_set8(u8_7, u8_6, u8_5, u8_4, u8_3, u8_2, u8_1, u8_0)                                                       \
    vcreate_u8(((uint64_t)(((uint32_t)(((uint16_t)(u8_7) << 8) | (uint16_t)(u8_6)) << 16) |                            \
                           ((uint32_t)(((uint16_t)(u8_5) << 8) | (uint16_t)(u8_4))))                                   \
                << 32) |                                                                                               \
               ((uint64_t)(((uint32_t)(((uint16_t)(u8_3) << 8) | (uint16_t)(u8_2)) << 16) |                            \
                           ((uint32_t)(((uint16_t)(u8_1) << 8) | (uint16_t)(u8_0))))))

#define v128_set64(u64_1, u64_0) vcombine_u64(vcreate_u64(u64_0), vcreate_u64(u64_1))

#define v128_set32(u32_3, u32_2, u32_1, u32_0) vcombine_u32(v64_set32(u32_1, u32_0), v64_set32(u32_3, u32_2))

#define v128_set16(u16_7, u16_6, u16_5, u16_4, u16_3, u16_2, u16_1, u16_0)                                             \
    vcombine_u16(v64_set16(u16_3, u16_2, u16_1, u16_0), v64_set16(u16_7, u16_6, u16_5, u16_4))

#define v128_set8(u8_f, u8_e, u8_d, u8_c, u8_b, u8_a, u8_9, u8_8, u8_7, u8_6, u8_5, u8_4, u8_3, u8_2, u8_1, u8_0)      \
...
#define v128_shuffle8(v, vmask) vqtbl1q_u8((uint8x16_t)(v), (uint8x16_t)(vmask))
