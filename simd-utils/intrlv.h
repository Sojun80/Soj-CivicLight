...
static inline void intrlv_2x32(void *dst, const void *src0, const void *src1, const int bit_len)
{
...
static inline void dintrlv_2x32(void *dst0, void *dst1, const void *src, const int bit_len)
{
...
static inline void extr_lane_2x32(void *dst, const void *src, const int lane, const int bit_len)
{
    uint32_t       *d = (uint32_t *)dst;
    const uint32_t *s = (const uint32_t *)src;
    d[0]              = s[lane];
...
static inline void
intrlv_4x32(void *dst, const void *src0, const void *src1, const void *src2, const void *src3, const int bit_len)
{
...
static inline void intrlv_4x32_512(void *dst, const void *src0, const void *src1, const void *src2, const void *src3)
{
    v128_t D0, D1, D2, D3, S0, S1, S2, S3;
...
static inline void dintrlv_4x32(void *dst0, void *dst1, void *dst2, void *dst3, const void *src, const int bit_len)
{
    v128_t D0, D1, D2, D3, S0, S1, S2, S3;
...
static inline void dintrlv_4x32_512(void *dst0, void *dst1, void *dst2, void *dst3, const void *src)
{
    v128_t D0, D1, D2, D3, S0, S1, S2, S3;
...
static inline void dintrlv_4x32(void *dst0, void *dst1, void *dst2, void *dst3, const void *src, int bit_len)
{
...
static inline void extr_lane_4x32(void *d, const void *s, const int lane, const int bit_len)
{
...
#define ILEAVE_8x32(D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7)                                    \
    {                                                                                                                  \
...
#define LOAD_SRCE_8x32(                                                                                                \
    S0, S1, S2, S3, S4, S5, S6, S7, src0, i0, src1, i1, src2, i2, src3, i3, src4, i4, src5, i5, src6, i6, src7, i7)    \
...
#define STOR_DEST_8x32(                                                                                                \
    D0, D1, D2, D3, D4, D5, D6, D7, dst0, i0, dst1, i1, dst2, i2, dst3, i3, dst4, i4, dst5, i5, dst6, i6, dst7, i7)    \
...
static inline void intrlv_8x32_256(void       *dst,
                                   const void *s0,
                                   const void *s1,
                                   const void *s2,
                                   const void *s3,
                                   ...
                                   const void *s7)
{
    __m256i D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7;

    LOAD_SRCE_8x32(S0, S1, S2, S3, S4, S5, S6, S7, s0, 0, s1, 0, s2, 0, s3, 0, s4, 0, s5, 0, s6, 0, s7, 0);
    ILEAVE_8x32(D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7);
    STOR_DEST_8x32(D0, D1, D2, D3, D4, D5, D6, D7, dst, 0, dst, 4, dst, 1, dst, 5, dst, 2, dst, 6, dst, 3, dst, 7);
}

static inline void intrlv_8x32_512(void       *dst,
                                   const void *s0,
                                   const void *s1,
                                   const void *s2,
                                   const void *s3,
                                   ...
                                   const void *s7)
{
    ...
    LOAD_SRCE_8x32(S0, S1, S2, S3, S4, S5, S6, S7, s0, 0, s1, 0, s2, 0, s3, 0, s4, 0, s5, 0, s6, 0, s7, 0);
    ILEAVE_8x32(D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7);
    LOAD_SRCE_8x32(S0, S1, S2, S3, S4, S5, S6, S7, s0, 1, s1, 1, s2, 1, s3, 1, s4, 1, s5, 1, s6, 1, s7, 1);
    STOR_DEST_8x32(D0, D1, D2, D3, D4, D5, D6, D7, dst, 0, dst, 4, dst, 1, dst, 5, dst, 2, dst, 6, dst, 3, dst, 7);
    ILEAVE_8x32(D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7);
    STOR_DEST_8x32(
        D0, D1, D2, D3, D4, D5, D6, D7, dst, 8, dst, 12, dst, 9, dst, 13, dst, 10, dst, 14, dst, 11, dst, 15);
}

static inline void dintrlv_8x32_256(
    void *dst0, void *dst1, void *dst2, void *dst3, void *dst4, void *dst5, void *dst6, void *dst7, const void *src)
{
    __m256i D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7;

    LOAD_SRCE_8x32(S0, S1, S2, S3, S4, S5, S6, S7, src, 0, src, 1, src, 2, src, 3, src, 4, src, 5, src, 6, src, 7);
    ILEAVE_8x32(D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7);
    STOR_DEST_8x32(
        D0, D1, D2, D3, D4, D5, D6, D7, dst0, 0, dst4, 0, dst1, 0, dst5, 0, dst2, 0, dst6, 0, dst3, 0, dst7, 0);
}

static inline void dintrlv_8x32_512(
    void *dst0, void *dst1, void *dst2, void *dst3, void *dst4, void *dst5, void *dst6, void *dst7, const void *src)
{
    __m256i D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7;
    ...
    ILEAVE_8x32(D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7);
    LOAD_SRCE_8x32(
        S0, S1, S2, S3, S4, S5, S6, S7, src, 8, src, 9, src, 10, src, 11, src, 12, src, 13, src, 14, src, 15);
    STOR_DEST_8x32(
        D0, D1, D2, D3, D4, D5, D6, D7, dst0, 0, dst4, 0, dst1, 0, dst5, 0, dst2, 0, dst6, 0, dst3, 0, dst7, 0);
    ILEAVE_8x32(D0, D1, D2, D3, D4, D5, D6, D7, S0, S1, S2, S3, S4, S5, S6, S7);
    STOR_DEST_8x32(
        D0, D1, D2, D3, D4, D5, D6, D7, dst0, 1, dst4, 1, dst1, 1, dst5, 1, dst2, 1, dst6, 1, dst3, 1, dst7, 1);
}
...
static inline void intrlv_8x32(void       *dst,
                               const void *s0,
                               const void *s1,
                               const void *s2,
                               const void *s3,
...
static inline void dintrlv_8x32(void       *dst0,
                                void       *dst1,
                                void       *dst2,
                                void       *dst3,
                                void       *dst4,
...
static inline void extr_lane_8x32(void *d, const void *s, const int lane, const int bit_len)
{
    ((uint32_t *)d)[0] = ((const uint32_t *)s)[lane];
...
static inline void mm256_bswap32_intrlv80_8x32(void *d, const void *src)
{
    ...
    casti_m256i(d, 0)  = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s0));
    casti_m256i(d, 1)  = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s0));
    casti_m256i(d, 2)  = _mm256_permutexvar_epi8(c2, _mm256_castsi128_si256(s0));
    casti_m256i(d, 3)  = _mm256_permutexvar_epi8(c3, _mm256_castsi128_si256(s0));
    casti_m256i(d, 4)  = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s1));
    casti_m256i(d, 5)  = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s1));
    casti_m256i(d, 6)  = _mm256_permutexvar_epi8(c2, _mm256_castsi128_si256(s1));
    casti_m256i(d, 7)  = _mm256_permutexvar_epi8(c3, _mm256_castsi128_si256(s1));
    casti_m256i(d, 8)  = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s2));
    casti_m256i(d, 9)  = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s2));
    casti_m256i(d, 10) = _mm256_permutexvar_epi8(c2, _mm256_castsi128_si256(s2));
    casti_m256i(d, 11) = _mm256_permutexvar_epi8(c3, _mm256_castsi128_si256(s2));
    casti_m256i(d, 12) = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s3));
    casti_m256i(d, 13) = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s3));
    casti_m256i(d, 14) = _mm256_permutexvar_epi8(c2, _mm256_castsi128_si256(s3));
    casti_m256i(d, 15) = _mm256_permutexvar_epi8(c3, _mm256_castsi128_si256(s3));
    casti_m256i(d, 16) = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s4));
    casti_m256i(d, 17) = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s4));
    casti_m256i(d, 18) = _mm256_permutexvar_epi8(c2, _mm256_castsi128_si256(s4));
    casti_m256i(d, 19) = _mm256_permutexvar_epi8(c3, _mm256_castsi128_si256(s4));
}
...
static inline void mm256_bswap32_intrlv80_8x32(void *d, const void *src)
{
    ...
    casti_m256i(d, 1) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s0), c1);
    casti_m256i(d, 2) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s0), c2);
    casti_m256i(d, 3) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s0), c3);

    casti_m256i(d, 4) = _mm256_broadcastd_epi32(s1);
    casti_m256i(d, 5) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s1), c1);
    casti_m256i(d, 6) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s1), c2);
    casti_m256i(d, 7) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s1), c3);

    casti_m256i(d, 8)  = _mm256_broadcastd_epi32(s2);
    casti_m256i(d, 9)  = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s2), c1);
    casti_m256i(d, 10) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s2), c2);
    casti_m256i(d, 11) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s2), c3);

    casti_m256i(d, 12) = _mm256_broadcastd_epi32(s3);
    casti_m256i(d, 13) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s3), c1);
    casti_m256i(d, 14) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s3), c2);
    casti_m256i(d, 15) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s3), c3);

    casti_m256i(d, 16) = _mm256_broadcastd_epi32(s4);
    casti_m256i(d, 17) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s4), c1);
    casti_m256i(d, 18) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s4), c2);
    casti_m256i(d, 19) = _mm256_permutevar8x32_epi32(_mm256_castsi128_si256(s4), c3);
}
...
static inline void intrlv_16x32(void       *dst,
                                const void *s00,
                                const void *s01,
                                const void *s02,
                                const void *s03,
...
// not used
static inline void intrlv_16x32_512(void       *dst,
                                    const void *s00,
                                    const void *s01,
                                    const void *s02,
                                    const void *s03,
...
static inline void dintrlv_16x32(void       *dst00,
                                 void       *dst01,
                                 void       *dst02,
                                 void       *dst03,
                                 void       *dst04,
...
// not used
static inline void dintrlv_16x32_512(void       *dst00,
                                     void       *dst01,
                                     void       *dst02,
                                     void       *dst03,
                                     void       *dst04,
...
static inline void extr_lane_16x32(void *d, const void *s, const int lane, const int bit_len)
{
    ((uint32_t *)d)[0] = ((const uint32_t *)s)[lane];
...
static inline void mm512_bswap32_intrlv80_16x32(void *d, const void *src)
{
    ...
    casti_m512i(d, 0)  = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s0));
    casti_m512i(d, 1)  = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s0));
    casti_m512i(d, 2)  = _mm512_permutexvar_epi8(c2, _mm512_castsi128_si512(s0));
    casti_m512i(d, 3)  = _mm512_permutexvar_epi8(c3, _mm512_castsi128_si512(s0));
    casti_m512i(d, 4)  = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s1));
    casti_m512i(d, 5)  = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s1));
    casti_m512i(d, 6)  = _mm512_permutexvar_epi8(c2, _mm512_castsi128_si512(s1));
    casti_m512i(d, 7)  = _mm512_permutexvar_epi8(c3, _mm512_castsi128_si512(s1));
    casti_m512i(d, 8)  = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s2));
    casti_m512i(d, 9)  = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s2));
    casti_m512i(d, 10) = _mm512_permutexvar_epi8(c2, _mm512_castsi128_si512(s2));
    casti_m512i(d, 11) = _mm512_permutexvar_epi8(c3, _mm512_castsi128_si512(s2));
    casti_m512i(d, 12) = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s3));
    casti_m512i(d, 13) = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s3));
    casti_m512i(d, 14) = _mm512_permutexvar_epi8(c2, _mm512_castsi128_si512(s3));
    casti_m512i(d, 15) = _mm512_permutexvar_epi8(c3, _mm512_castsi128_si512(s3));
    casti_m512i(d, 16) = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s4));
    casti_m512i(d, 17) = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s4));
    casti_m512i(d, 18) = _mm512_permutexvar_epi8(c2, _mm512_castsi128_si512(s4));
    casti_m512i(d, 19) = _mm512_permutexvar_epi8(c3, _mm512_castsi128_si512(s4));
}
...
static inline void mm512_bswap32_intrlv80_16x32(void *d, const void *src)
{
    ...
    casti_m512i(d, 1) = _mm512_permutexvar_epi32(c1, _mm512_castsi128_si512(s0));
    casti_m512i(d, 2) = _mm512_permutexvar_epi32(c2, _mm512_castsi128_si512(s0));
    casti_m512i(d, 3) = _mm512_permutexvar_epi32(c3, _mm512_castsi128_si512(s0));

    casti_m512i(d, 4) = _mm512_broadcastd_epi32(s1);
    casti_m512i(d, 5) = _mm512_permutexvar_epi32(c1, _mm512_castsi128_si512(s1));
    casti_m512i(d, 6) = _mm512_permutexvar_epi32(c2, _mm512_castsi128_si512(s1));
    casti_m512i(d, 7) = _mm512_permutexvar_epi32(c3, _mm512_castsi128_si512(s1));

    casti_m512i(d, 8)  = _mm512_broadcastd_epi32(s2);
    casti_m512i(d, 9)  = _mm512_permutexvar_epi32(c1, _mm512_castsi128_si512(s2));
    casti_m512i(d, 10) = _mm512_permutexvar_epi32(c2, _mm512_castsi128_si512(s2));
    casti_m512i(d, 11) = _mm512_permutexvar_epi32(c3, _mm512_castsi128_si512(s2));

    casti_m512i(d, 12) = _mm512_broadcastd_epi32(s3);
    casti_m512i(d, 13) = _mm512_permutexvar_epi32(c1, _mm512_castsi128_si512(s3));
    casti_m512i(d, 14) = _mm512_permutexvar_epi32(c2, _mm512_castsi128_si512(s3));
    casti_m512i(d, 15) = _mm512_permutexvar_epi32(c3, _mm512_castsi128_si512(s3));

    casti_m512i(d, 16) = _mm512_broadcastd_epi32(s4);
    casti_m512i(d, 17) = _mm512_permutexvar_epi32(c1, _mm512_castsi128_si512(s4));
    casti_m512i(d, 18) = _mm512_permutexvar_epi32(c2, _mm512_castsi128_si512(s4));
    casti_m512i(d, 19) = _mm512_permutexvar_epi32(c3, _mm512_castsi128_si512(s4));
}
...
static inline void intrlv_2x64(void *dst, const void *src0, const void *src1, const int bit_len)
{
...
static inline void dintrlv_2x64(void *dst0, void *dst1, const void *src, const int bit_len)
{
...
static inline void extr_lane_2x64(void *dst, const void *src, const int lane, const int bit_len)
{
    uint64_t       *d = (uint64_t *)dst;
    const uint64_t *s = (const uint64_t *)src;
    d[0]              = s[lane];
...
static inline void
intrlv_4x64(void *dst, const void *src0, const void *src1, const void *src2, const void *src3, const int bit_len)
{
    v128_t       *d  = (v128_t *)dst;
...
static inline void intrlv_4x64_512(void *dst, const void *src0, const void *src1, const void *src2, const void *src3)
{
    v128_t          *d  = (v128_t *)dst;
    const v128u64_t *s0 = (const v128u64_t *)src0;
    const v128u64_t *s1 = (const v128u64_t *)src1;
...
static inline void dintrlv_4x64(void *dst0, void *dst1, void *dst2, void *dst3, const void *src, const int bit_len)
{
...
static inline void dintrlv_4x64_512(void *dst0, void *dst1, void *dst2, void *dst3, const void *src)
{
    v128u64_t    *d0 = (v128u64_t *)dst0;
    v128u64_t    *d1 = (v128u64_t *)dst1;
...
static inline void extr_lane_4x64(void *dst, const void *src, const int lane, const int bit_len)
{
    v128u64_t       *d = (v128u64_t *)dst;
    const v128u64_t *s = (const v128u64_t *)src;
    int              i = lane / 2;
...
static inline void mm256_intrlv80_4x64(void *d, const void *src)
{
    ...
    casti_m256i(d, 8) = _mm256_permute4x64_epi64(_mm256_castsi128_si256(s4), 0x00);
    casti_m256i(d, 9) = _mm256_permute4x64_epi64(_mm256_castsi128_si256(s4), 0x55);
}
...
static inline void mm256_bswap32_intrlv80_4x64(void *d, const void *src)
{
    ...
    casti_m256i(d, 0) = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s0));
    casti_m256i(d, 1) = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s0));
    casti_m256i(d, 2) = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s1));
    casti_m256i(d, 3) = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s1));
    casti_m256i(d, 4) = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s2));
    casti_m256i(d, 5) = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s2));
    casti_m256i(d, 6) = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s3));
    casti_m256i(d, 7) = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s3));
    casti_m256i(d, 8) = _mm256_permutexvar_epi8(c0, _mm256_castsi128_si256(s4));
    casti_m256i(d, 9) = _mm256_permutexvar_epi8(c1, _mm256_castsi128_si256(s4));
}
...
static inline void intrlv_8x64(void       *dst,
                               const void *src0,
                               const void *src1,
                               const void *src2,
                               const void *src3,
...
static inline void intrlv_8x64_512(void       *dst,
                                   const void *src0,
                                   const void *src1,
                                   const void *src2,
                                   const void *src3,
...
static inline void dintrlv_8x64(void       *dst0,
                                void       *dst1,
                                void       *dst2,
                                void       *dst3,
                                void       *dst4,
...
static inline void dintrlv_8x64_512(
    void *dst0, void *dst1, void *dst2, void *dst3, void *dst4, void *dst5, void *dst6, void *dst7, const void *src)
{
    v128u64_t       *d0 = (v128u64_t *)dst0;
    v128u64_t       *d1 = (v128u64_t *)dst1;
...
static inline void extr_lane_8x64(void *dst, const void *src, const int lane, const int bit_len)
{
    v128u64_t       *d = (v128u64_t *)dst;
    const v128u64_t *s = (const v128u64_t *)src;
    int              i = lane / 2;
...
static inline void mm512_bswap32_intrlv80_8x64(void *d, const void *src)
{
    ...
    casti_m512i(d, 0) = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s0));
    casti_m512i(d, 1) = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s0));
    casti_m512i(d, 2) = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s1));
    casti_m512i(d, 3) = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s1));
    casti_m512i(d, 4) = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s2));
    casti_m512i(d, 5) = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s2));
    casti_m512i(d, 6) = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s3));
    casti_m512i(d, 7) = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s3));
    casti_m512i(d, 8) = _mm512_permutexvar_epi8(c0, _mm512_castsi128_si512(s4));
    casti_m512i(d, 9) = _mm512_permutexvar_epi8(c1, _mm512_castsi128_si512(s4));
}
...
static inline void mm512_bswap32_intrlv80_8x64(void *d, const void *src)
{
    ...
    casti_m512i(d, 1) = _mm512_permutexvar_epi64(c1, _mm512_castsi128_si512(s0));
    casti_m512i(d, 2) = _mm512_broadcastq_epi64(s1);
    casti_m512i(d, 3) = _mm512_permutexvar_epi64(c1, _mm512_castsi128_si512(s1));
    casti_m512i(d, 4) = _mm512_broadcastq_epi64(s2);
    casti_m512i(d, 5) = _mm512_permutexvar_epi64(c1, _mm512_castsi128_si512(s2));
    casti_m512i(d, 6) = _mm512_broadcastq_epi64(s3);
    casti_m512i(d, 7) = _mm512_permutexvar_epi64(c1, _mm512_castsi128_si512(s3));
    casti_m512i(d, 8) = _mm512_broadcastq_epi64(s4);
    casti_m512i(d, 9) = _mm512_permutexvar_epi64(c1, _mm512_castsi128_si512(s4));
}
...
static inline void intrlv_2x128(void *dst, const void *src0, const void *src1, const int bit_len)
{
    v128_t       *d  = (v128_t *)dst;
    const v128_t *s0 = (const v128_t *)src0;
    const v128_t *s1 = (const v128_t *)src1;
...
static inline void intrlv_2x128_512(void *dst, const void *src0, const void *src1)
{
    v128_t       *d  = (v128_t *)dst;
    const v128_t *s0 = (const v128_t *)src0;
    const v128_t *s1 = (const v128_t *)src1;
...
static inline void dintrlv_2x128(void *dst0, void *dst1, const void *src, int bit_len)
{
...
static inline void
intrlv_4x128(void *dst, const void *src0, const void *src1, const void *src2, const void *src3, const int bit_len)
{
    v128_t       *d  = (v128_t *)dst;
    const v128_t *s0 = (const v128_t *)src0;
    const v128_t *s1 = (const v128_t *)src1;
...
static inline void intrlv_4x128_512(void *dst, const void *src0, const void *src1, const void *src2, const void *src3)
{
    v128_t       *d  = (v128_t *)dst;
    const v128_t *s0 = (const v128_t *)src0;
    const v128_t *s1 = (const v128_t *)src1;
...
static inline void dintrlv_4x128(void *dst0, void *dst1, void *dst2, void *dst3, const void *src, const int bit_len)
{
    v128_t       *d0 = (v128_t *)dst0;
    v128_t       *d1 = (v128_t *)dst1;
...
static inline void dintrlv_4x128_512(void *dst0, void *dst1, void *dst2, void *dst3, const void *src)
{
    v128_t       *d0 = (v128_t *)dst0;
    v128_t       *d1 = (v128_t *)dst1;
    v128_t       *d2 = (v128_t *)dst2;
...
static inline void mm512_bswap32_intrlv80_4x128(void *d, const void *src)
{
    ...
    casti_m512i(d, 0) = _mm512_permutexvar_epi8(V512_BSWAP32, _mm512_castsi128_si512(s0));
    casti_m512i(d, 1) = _mm512_permutexvar_epi8(V512_BSWAP32, _mm512_castsi128_si512(s1));
    casti_m512i(d, 2) = _mm512_permutexvar_epi8(V512_BSWAP32, _mm512_castsi128_si512(s2));
    casti_m512i(d, 3) = _mm512_permutexvar_epi8(V512_BSWAP32, _mm512_castsi128_si512(s3));
    casti_m512i(d, 4) = _mm512_permutexvar_epi8(V512_BSWAP32, _mm512_castsi128_si512(s4));
}
...
static inline void intrlv_2x256(void *dst, const void *src0, const void *src1, const int bit_len)
{
...
// No 80 byte dintrlv
static inline void dintrlv_2x256(void *dst0, void *dst1, const void *src, int bit_len)
{
...
static inline void rintrlv_4x64_4x32(void *dst, const void *src, const int bit_len)
{
    const v128_t *s = (const v128_t *)src;
    v128_t       *d = (v128_t *)dst;
...
static inline void rintrlv_8x64_8x32(void *dst, const void *src, const int bit_len)
{
    const v128_t *s = (const v128_t *)src;
    v128_t       *d = (v128_t *)dst;
...
static inline void rintrlv_4x32_4x64(void *dst, const void *src, const int bit_len)
{
...
static inline void rintrlv_8x32_8x64(void *dst, const void *src, const int bit_len)
{
    v128_t       *d = (v128_t *)dst;
    const v128_t *s = (const v128_t *)src;
...
static inline void rintrlv_8x32_4x128(void *dst0, void *dst1, const void *src, const int bit_len)
{
    RLEAVE_8X32_4X128(0);
...
static inline void rintrlv_2x128_4x64(void *dst, const void *src0, const void *src1, const int bit_len)
{
    v128_t          *d  = (v128_t *)dst;
    const v128u64_t *s0 = (const v128u64_t *)src0;
    const v128u64_t *s1 = (const v128u64_t *)src1;
...
static inline void rintrlv_4x64_2x128(void *dst0, void *dst1, const void *src, const int bit_len)
{
    v128u64_t       *d0 = (v128u64_t *)dst0;
    v128u64_t       *d1 = (v128u64_t *)dst1;
    const v128u64_t *s  = (const v128u64_t *)src;
...
static inline void rintrlv_4x128_8x64(void *dst, const void *src0, const void *src1, const int bit_len)
{
...
static inline void rintrlv_8x64_4x128(void *dst0, void *dst1, const void *src, const int bit_len)
{
    v128u64_t       *d0 = (v128u64_t *)dst0;
    v128u64_t       *d1 = (v128u64_t *)dst1;
    const v128u64_t *s  = (const v128u64_t *)src;
...
static inline void
rintrlv_8x64_2x256(void *dst0, void *dst1, void *dst2, void *dst3, const void *src, const int bit_len)
{
    v128u64_t    *d0 = (v128u64_t *)dst0;
    v128u64_t    *d1 = (v128u64_t *)dst1;
    v128u64_t    *d2 = (v128u64_t *)dst2;
...
static inline void
rintrlv_2x256_8x64(void *dst, const void *src0, const void *src1, const void *src2, const void *src3, const int bit_len)
{
    v128u64_t       *d  = (v128u64_t *)dst;
    const v128u64_t *s0 = (const v128u64_t *)src0;
    const v128u64_t *s1 = (const v128u64_t *)src1;
...
#define v128_intrlv_blend_64(hi, lo) v128_blendv(hi, lo, v128_set64(0ull, 0xffffffffffffffffull))

#define v128_intrlv_blend_32(hi, lo) v128_blendv(hi, lo, v128_set64(0xffffffffull, 0xffffffffull))
