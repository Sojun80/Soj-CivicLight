...
void sha256_x86_x2sha_final_rounds(uint32_t       *out_X,
                                   uint32_t       *out_Y,
                                   const void     *msg_X,
                                   const void     *msg_Y,
...
#define sha256_neon_x2sha_rounds(state_out_X, state_out_Y, input_X, input_Y, state_in_X, state_in_Y)                   \
    {                                                                                                                  \
...
void sha256_neon_prehash_3rounds(uint32_t *ostate, const void *msg, uint32_t *sstate, const uint32_t *istate)
{
