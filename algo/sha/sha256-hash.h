...
void sha256_x86_sha_transform_le(uint32_t *state_out, const void *input, const uint32_t *state_in);

void sha256_x86_sha_transform_be(uint32_t *state_out, const void *input, const uint32_t *state_in);

// 2 way serial with interleaved instructions
void sha256_x86_x2sha_transform_le(
    uint32_t *out_X, uint32_t *out_Y, const void *msg_X, const void *msg_Y, const uint32_t *in_X, const uint32_t *in_Y);

void sha256_x86_x2sha_transform_be(
    uint32_t *out_X, uint32_t *out_Y, const void *msg_X, const void *msg_Y, const uint32_t *in_X, const uint32_t *in_Y);

void sha256_x86_sha_prehash_3rounds(uint32_t *ostate, const void *msg, uint32_t *sstate, const uint32_t *istate);

void sha256_x86_x2sha_final_rounds(uint32_t       *state_out_X,
                                   uint32_t       *state_out_Y,
                                   const void     *msg_X,
                                   const void     *msg_Y,
                                   const uint32_t *state_mid_X,
                                   const uint32_t *state_mid_Y,
                                   const uint32_t *state_save_X,
                                   const uint32_t *state_save_Y);
...
void sha256_neon_sha_transform_be(uint32_t *state_out, const void *input, const uint32_t *state_in);
void sha256_neon_sha_transform_le(uint32_t *state_out, const void *input, const uint32_t *state_in);

void sha256_neon_x2sha_transform_le(
    uint32_t *out_X, uint32_t *out_Y, const void *msg_X, const void *msg_Y, const uint32_t *in_X, const uint32_t *in_Y);

void sha256_neon_x2sha_transform_be(
    uint32_t *out_X, uint32_t *out_Y, const void *msg_X, const void *msg_Y, const uint32_t *in_X, const uint32_t *in_Y);

void sha256_neon_sha_prehash_3rounds(uint32_t *ostate, const void *msg, uint32_t *sstate, const uint32_t *istate);
...
/* Software 2-way fallback: no interleaving benefit without SHA-NI,
 * just call the single-way transform twice sequentially. */
static inline void sph_sha256_2x_transform_le(
    uint32_t *out_X, uint32_t *out_Y, const void *msg_X, const void *msg_Y, const uint32_t *in_X, const uint32_t *in_Y)
{
    sph_sha256_transform_le(out_X, msg_X, in_X);
    sph_sha256_transform_le(out_Y, msg_Y, in_Y);
}

static inline void sph_sha256_2x_transform_be(
    uint32_t *out_X, uint32_t *out_Y, const void *msg_X, const void *msg_Y, const uint32_t *in_X, const uint32_t *in_Y)
{
    sph_sha256_transform_be(out_X, msg_X, in_X);
    sph_sha256_transform_be(out_Y, msg_Y, in_Y);
}

#define sha256_2x_transform_le sph_sha256_2x_transform_le
#define sha256_2x_transform_be sph_sha256_2x_transform_be
...
void sha256_16x32_transform_le(__m512i *state_out, const __m512i *data, const __m512i *state_in);
void sha256_16x32_transform_be(__m512i *state_out, const __m512i *data, const __m512i *state_in);
void sha256_16x32_prehash_3rounds(__m512i *state_mid, __m512i *X, const __m512i *W, const __m512i *state_in);
void sha256_16x32_final_rounds(
    __m512i *state_out, const __m512i *data, const __m512i *state_in, const __m512i *state_mid, const __m512i *X);

int sha256_16x32_transform_le_short(__m512i        *state_out,
                                    const __m512i  *data,
...
void sha256_8x32_transform_le(__m256i *state_out, const __m256i *data, const __m256i *state_in);
void sha256_8x32_transform_be(__m256i *state_out, const __m256i *data, const __m256i *state_in);

void sha256_8x32_prehash_3rounds(__m256i *state_mid, __m256i *X, const __m256i *W, const __m256i *state_in);
void sha256_8x32_final_rounds(
    __m256i *state_out, const __m256i *data, const __m256i *state_in, const __m256i *state_mid, const __m256i *X);
int sha256_8x32_transform_le_short(__m256i        *state_out,
                                   const __m256i  *data,
...
void sha256_4x32_transform_le(v128_t *state_out, const v128_t *data, const v128_t *state_in);
void sha256_4x32_transform_be(v128_t *state_out, const v128_t *data, const v128_t *state_in);
void sha256_4x32_prehash_3rounds(v128_t *state_mid, v128_t *X, const v128_t *W, const v128_t *state_in);
void sha256_4x32_final_rounds(
    v128_t *state_out, const v128_t *data, const v128_t *state_in, const v128_t *state_mid, const v128_t *X);
int sha256_4x32_transform_le_short(v128_t         *state_out,
                                   const v128_t   *data,
