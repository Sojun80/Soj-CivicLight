...
#define bswap_64(x)                                                                                                    \
    ((((x) & 0x00000000FFFFFFFF) << 32) | (((x) & 0xFFFFFFFF00000000) >> 32) | (((x) & 0x0000FFFF0000FFFF) << 16) |    \
     (((x) & 0xFFFF0000FFFF0000) >> 16) | (((x) & 0x00FF00FF00FF00FF) << 8) | (((x) & 0xFF00FF00FF00FF00) >> 8))
...
#define bswap_32x2(u64)                                                                                                \
    (((u64) & 0xff000000ff000000) >> 24) | (((u64) & 0x00ff000000ff0000) >> 8) | (((u64) & 0x0000ff000000ff00) << 8) | \
...
#define safe_div(dividend, divisor, safe_result) ((divisor) == 0 ? safe_result : ((dividend) / (divisor)))
