...
#define v128_xoraesenc(v, k) _mm_aesenc_si128(v128_xor(v, k), v128_zero)
...
#define v128_xoraesencxor(v, k_in, k_out) _mm_aesenc_si128(v128_xor(v, k_in), k_out)
...
#define v128_duplane64(v, l) ((l) == 0) ? _mm_shuffle_epi32(v, 0x44) : _mm_shuffle_epi32(v, 0xee)
...
#define v128_xim32(v1, v0, c) _mm_castps_si128(_mm_insert_ps(_mm_castsi128_ps(v1), _mm_castsi128_ps(v0), c))
...
#define v128_movlane32(v1, l1, v0, l0) v128_xim32(v1, v0, ((l1) << 4) | ((l0) << 6))
...
#define v128_add4_64(a, b, c, d) _mm_add_epi64(_mm_add_epi64(a, b), _mm_add_epi64(c, d))

#define v128_add4_32(a, b, c, d) _mm_add_epi32(_mm_add_epi32(a, b), _mm_add_epi32(c, d))

#define v128_add4_16(a, b, c, d) _mm_add_epi16(_mm_add_epi16(a, b), _mm_add_epi16(c, d))

#define v128_add4_8(a, b, c, d) _mm_add_epi8(_mm_add_epi8(a, b), _mm_add_epi8(c, d))

#define v128_xor4(a, b, c, d) _mm_xor_si128(_mm_xor_si128(a, b), _mm_xor_si128(c, d))
...
#define v128_movmask64(v) _mm_movemask_pd((__m128d)(v))

#define v128_movmask32(v) _mm_movemask_ps((__m128)(v))

// Shuffle 16 bit elements within 64 bit lanes.
#define v128_shuffle16(v, c) _mm_shufflehi_epi16(_mm_shufflelo_epi16(v, c), c)
...
#define v128_ror64_sse2(v, c) _mm_or_si128(_mm_srli_epi64(v, c), _mm_slli_epi64(v, 64 - (c)))

#define v128_rol64_sse2(v, c) _mm_or_si128(_mm_slli_epi64(v, c), _mm_srli_epi64(v, 64 - (c)))

#define v128_ror32_sse2(v, c) _mm_or_si128(_mm_srli_epi32(v, c), _mm_slli_epi32(v, 32 - (c)))

#define v128_rol32_sse2(v, c) _mm_or_si128(_mm_slli_epi32(v, c), _mm_srli_epi32(v, 32 - (c)))
...
#define v128_ror32(v, c) ((c) == 16) ? v128_lrev16(v) : v128_ror32_sse2(v, c)

#define v128_rol32(v, c) ((c) == 16) ? v128_lrev16(v) : v128_rol32_sse2(v, c)
...
#define v128_shuffle2_64(v1, v2, c) _mm_castpd_si128(_mm_shuffle_pd(_mm_castsi128_pd(v1), _mm_castsi128_pd(v2), c));

#define v128_shuffle2_32(v1, v2, c) _mm_castps_si128(_mm_shuffle_ps(_mm_castsi128_ps(v1), _mm_castsi128_ps(v2), c));
...
#define v128_bswap128(v) _mm_shuffle_epi8(v, _mm_set_epi64x(0x0001020304050607, 0x08090a0b0c0d0e0f))
...
#define v128_alignr8(hi, lo, c) _mm_or_si128(_mm_slli_si128(hi, 16 - (c)), _mm_srli_si128(lo, c))

// c arg is trivial only valid value is 1
#define v128_alignr64(hi, lo, c) _mm_or_si128(_mm_slli_si128(hi, 16 - ((c) * 8)), _mm_srli_si128(lo, (c) * 8))

#define v128_alignr32(hi, lo, c) _mm_or_si128(_mm_slli_si128(hi, 16 - ((c) * 4)), _mm_srli_si128(lo, (c) * 4))
...
#define v128_blendv(v1, v0, mask) v128_or(v128_andnot(mask, v1), v128_and(mask, v0))
