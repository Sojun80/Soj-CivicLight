...
#define mm256_bcast128(v) _mm256_permute4x64_epi64(_mm256_castsi128_si256(v), 0x44)
// deprecated
...
#define mm256_bcast128hi_64(i64) _mm256_permute4x64_epi64(_mm256_castsi128_si256(v128_mov64(i64)), 0x11)

#endif

#define mm256_set2_64(i1, i0) mm256_bcast128(_mm_set_epi64x(i1, i0))

#define mm256_set4_32(i3, i2, i1, i0) mm256_bcast128(_mm_set_epi32(i3, i2, i1, i0))
...
#define mm256_add4_64(a, b, c, d) _mm256_add_epi64(_mm256_add_epi64(a, b), _mm256_add_epi64(c, d))

#define mm256_add4_32(a, b, c, d) _mm256_add_epi32(_mm256_add_epi32(a, b), _mm256_add_epi32(c, d))
...
// processed first.
#define mm256_xor3(a, b, c) _mm256_xor_si256(_mm256_xor_si256(a, b), c)

#define mm256_xor4(a, b, c, d) _mm256_xor_si256(_mm256_xor_si256(a, b), _mm256_xor_si256(c, d))

#define mm256_and3(a, b, c) _mm256_and_si256(_mm256_and_si256(a, b), c)

#define mm256_or3(a, b, c) _mm256_or_si256(_mm256_or_si256(a, b), c)

#define mm256_xorand(a, b, c) _mm256_xor_si256(a, _mm256_and_si256(b, c))

#define mm256_andxor(a, b, c) _mm256_and_si256(a, _mm256_xor_si256(b, c))

#define mm256_xoror(a, b, c) _mm256_xor_si256(a, _mm256_or_si256(b, c))

#define mm256_xorandnot(a, b, c) _mm256_xor_si256(a, _mm256_andnot_si256(b, c))

#define mm256_orand(a, b, c) _mm256_or_si256(a, _mm256_and_si256(b, c))

#define mm256_xnor(a, b) mm256_not(_mm256_xor_si256(a, b))
...
// data integrity.
#define mm256_movmask_64(v) _mm256_movemask_pd(_mm256_castsi256_pd(v))

#define mm256_movmask_32(v) _mm256_movemask_ps(_mm256_castsi256_ps(v))

// shuffle 16 bit elements within 64 bit lanes.
#define mm256_shuffle16(v, c) _mm256_shufflehi_epi16(_mm256_shufflelo_epi16(v, c), c)
...
#define mm256_ror_64_avx2(v, c) _mm256_or_si256(_mm256_srli_epi64(v, c), _mm256_slli_epi64(v, 64 - (c)))

#define mm256_rol_64_avx2(v, c) _mm256_or_si256(_mm256_slli_epi64(v, c), _mm256_srli_epi64(v, 64 - (c)))

#define mm256_ror_32_avx2(v, c) _mm256_or_si256(_mm256_srli_epi32(v, c), _mm256_slli_epi32(v, 32 - (c)))

#define mm256_rol_32_avx2(v, c) _mm256_or_si256(_mm256_slli_epi32(v, c), _mm256_srli_epi32(v, 32 - (c)))
...
#define mm256_shuffle2_64(v1, v2, c)                                                                                   \
    _mm256_castpd_si256(_mm256_shuffle_pd(_mm256_castsi256_pd(v1), _mm256_castsi256_pd(v2), c));

#define mm256_shuffle2_32(v1, v2, c)                                                                                   \
    _mm256_castps_si256(_mm256_shuffle_ps(_mm256_castsi256_ps(v1), _mm256_castsi256_ps(v2), c));
...
#define mm256_alignr64(v1, v0, c)                                                                                      \
    (((c) & 3) == 1)   ? _mm256_blend_epi32(mm256_shuflr_64(v1), mm256_shuflr_64(v0), 0x3f)                            \
    : (((c) & 3) == 2) ? _mm256_blend_epi32(mm256_rev_128(v1), mm256_rev_128(v0), 0x0f)                                \
    : (((c) & 3) == 3) ? _mm256_blend_epi32(mm256_shufll_64(v1), mm256_shufll_64(v0), 0x03)                            \
                       : v0
