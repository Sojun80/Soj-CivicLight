...
void sha1_x86_sha_transform_le(uint32_t *state_out, const void *input, const uint32_t *state_in)
{
...
void sha1_x86_sha_transform_be(uint32_t *state_out, const void *input, const uint32_t *state_in)
{
...
void sha1_neon_sha_transform_be(uint32_t *state_out, const void *input, const uint32_t *state_in)
{
...
void sha1_neon_sha_transform_le(uint32_t *state_out, const void *input, const uint32_t *state_in)
{
#define load_msg(m, i) casti_v128(m, i);
    sha1_neon_rounds(state_out, input, state_in);
#undef load_msg
