...
#define mm512_shuffle_i64x2(v, c) _mm512_shuffle_i64x2(v, v, c)

// Broadcast 128 bit vector to all lanes of 512 bit vector.
#define mm512_bcast128(v) _mm512_broadcast_i32x4(v)
// deprecated
...
#define mm512_set2_64(i1, i0) mm512_bcast128(_mm_set_epi64x(i1, i0))
...
#define mm512_add4_64(a, b, c, d) _mm512_add_epi64(_mm512_add_epi64(a, b), _mm512_add_epi64(c, d))

#define mm512_add4_32(a, b, c, d) _mm512_add_epi32(_mm512_add_epi32(a, b), _mm512_add_epi32(c, d))
...
#define mm512_shuffle16(v, c) _mm512_shufflehi_epi16(_mm512_shufflelo_epi16(v, c), c)
...
#define mm512_shuffle2_64(v1, v2, c)                                                                                   \
    _mm512_castpd_si512(_mm512_shuffle_pd(_mm512_castsi512_pd(v1), _mm512_castsi512_pd(v2), c));

#define mm512_shuffle2_32(v1, v2, c)                                                                                   \
    _mm512_castps_si512(_mm512_shuffle_ps(_mm512_castsi512_ps(v1), _mm512_castsi512_ps(v2), c));
